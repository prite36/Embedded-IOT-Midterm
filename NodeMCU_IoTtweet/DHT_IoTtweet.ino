...
const char *userid = "000980";            //IoTtweet account user ID (6 digits, included zero pre-fix)
const char *key = "5fyt7m2kuikp";     //IoTtweet registered device key in "MY IOT Garage"
...
const char *password = "bc123456";            //Your-WiFi-password
...
void loop() {
  ...
  Serial.print("Random 1 = ");Serial.println(data2);
  Serial.print("Random 2 = ");Serial.println(data3);
